...
public class MapsToMaps {
    ...
    public static void mapsToMaps(){
        ...
        // V2 -> V1
        channelToSubscribers.forEach((channel, numSubs) -> {
            ...
            if (publisherToSubscribers.containsKey(publisher)) {
                ...
                int newVal = numSubs + currentSubs;
        ...
        publisherToSubscribers.forEach((publisher, numSubs) -> {
            System.out.println("publisher: "+ publisher + "; numSubscribers: "+ numSubs);
        });
        ...
        publisherToSubscribers.forEach((publisher, numSubs) -> {
            if(numSubs == min) {
                System.out.println("Publisher with fewest subscribers: " + publisher);
            }
            if (numSubs == max) {
                System.out.println("Publisher with most subscribers: " + publisher);
            }
        });
